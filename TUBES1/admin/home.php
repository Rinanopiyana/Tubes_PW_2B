      ...
      <div class="container">
        <div class="intro">
          ...
          <div class="intro-text left-0 text-center bg-faded p-5 rounded">
            ...
            <p class="mb-3">Setiap cangkir kopi penganan berkualitas kami dimulai dengan bahan-bahan yang dipetik dari sumber lokal. Setelah Anda mencobanya, kopi kami akan menjadi tambahan yang menyenangkan untuk rutinitas pagi Anda sehari-hari - kami jamin!
            </p>
          </div>
        </div>
      </div>
          ...
          <div class="col-xl-9 mx-auto">
            <div class="cta-inner text-center rounded">
              <h2 class="section-heading mb-4">
                ...
                <span class="section-heading-lower">Kepada Anda</span>
              </h2>
              <p class="mb-0">Ketika Anda masuk ke kedai kami untuk memulai hari Anda, kami berdedikasi untuk memberi Anda layanan yang ramah, suasana yang ramah, dan di atas segalanya, produk unggulan yang dibuat dengan bahan-bahan berkualitas terbaik. Jika Anda tidak puas, beri tahu kami dan kami akan melakukan apa pun yang kami bisa untuk memperbaikinya!</p>
            </div>
          </div>
        </div>
      </div>
